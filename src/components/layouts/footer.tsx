    ...
    <footer className="flex-1 flex flex-col justify-between max-w-4xl mx-auto w-full px-6 py-8">
        <section className="flex flex-row justify-between items-center my-8 md:my-16 gap-4 md:gap-8">
            <div className="flex-1">
                <h2 className="text-xl md:text-2xl font-bold text-[#102A56] mb-2">CONTACT</h2>
                <p className="text-[#102A56] text-xs md:text-sm font-medium leading-relaxed mb-4 md:mb-8 max-w-xs">
                ...
                <div className="hidden md:flex items-center gap-2 md:gap-3">
                    ...
                    <a href="mailto:admin@starkwager.xyz" className="text-[#102A56] text-sm md:text-base font-bold">
        ...
        <div className="flex md:hidden items-center gap-2 mb-4">
            ...
            <a href="mailto:admin@starkwager.xyz" className="text-[#102A56] text-sm font-bold">
            admin@starkwager.xyz
            </a>
        </div>
        ...
        <section className="flex flex-col md:flex-row items-start md:items-center my-6 md:my-2 gap-2 md:gap-4">
            <div className="text-[#102A56] text-xl md:text-2xl font-bold whitespace-nowrap">
            DID YOU KNOW?
            </div>
            <div className="text-[#102A56] font-medium text-xs md:text-sm leading-relaxed max-w-sm">
        ...
        <section className="flex flex-col md:flex-row justify-between items-start md:items-center mt-8 md:mt-16 pt-8 gap-4">
            ...
            <div className="flex justify-between w-full md:w-auto md:gap-8">
                <div className="text-[#102A56] text-xs md:text-sm">
