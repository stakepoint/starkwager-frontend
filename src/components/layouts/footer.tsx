...
export default function Footer() {
  return (
    <footer className="flex-1 flex flex-col justify-between mx-auto w-full px-[14vw] py-8 bg-white">
        <section className="flex flex-row justify-between items-center my-8 md:my-16 gap-4 md:gap-8">
            <div className="flex-1">
                <h2 className="text-xl md:text-2xl font-bold text-[#102A56] mb-2 font-generalSans">CONTACT</h2>
                ...
                <div className="hidden md:flex items-center gap-2 md:gap-3">
                    ...
                    <a href="mailto:admin@starkwager.xyz" className="text-[#102A56] text-sm md:text-base font-bold font-generalSans">
        ...
        <div className="flex md:hidden items-center gap-2 mb-4">
            ...
            <a href="mailto:admin@starkwager.xyz" className="text-[#102A56] text-sm font-bold font-generalSans">
            admin@starkwager.xyz
            </a>
        </div>
