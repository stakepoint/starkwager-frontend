            ...
            {[
              {
                ...
                title: [
                  <div
                    key="1-0"
                    className="font-comedik text-[32px] text-[#6C737F]"
                  >
                    STEP 1
                  </div>,
                  <div
                    key="1-1"
                    className="font-general-sans font-bold text-[16px] text-[#6C737F]"
                  >
                    CONNECT YOUR
                  </div>,
                  <div
              ...
              },
              {
                ...
                title: [
                  <div
                    key="3-0"
                    className="font-comedik text-[32px] text-[#E0FE10]"
                  >
                    STEP 3
                  </div>,
                  <div
                    key="3-1"
                    className="font-general-sans font-bold text-[16px] text-[#EFF8FF]"
                  >
                    CLAIM WINNINGS,
                  </div>,
                  <div
              ...
              <div
                key={index}
                className={`grid grid-cols-1 md:grid-cols-2 ${item || ""} py-4`}
              >
                <div
