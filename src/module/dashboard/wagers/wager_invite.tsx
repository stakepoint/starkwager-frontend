    ...
    <section className="mx-auto py-[2rem] pb-24 lg:py-[4rem] max-w-lg">
      <div>
        ...
        <section className="grid gap-4">
          <div>
            <label className="text-sm text-blue-950 dark:text-white tracking-tighter">
          ...
          <div className="gap-3">
            <p className="text-sm font-medium text-[#102A56] dark:text-white tracking-tighter">
              Invite publicly (Anyone with this link can join it)
            </p>
            <div className="mt-1 flex items-center bg-[#EFF1F5] dark:bg-grey-8 rounded-lg px-4 py-6 h-[72px] relative">
              <div className="gap-1 h-5 flex">
                <input
                  type="text"
                  readOnly
                  value="https://link.wager.strk/WEpl"
                  className="flex-1 bg-transparent text-gray-800 dark:text-white outline-none w-full"
                />
                <div
      ...
      <div className="flex pt-10 w-full flex-col gap-2">
        <Button className="text-base dark:bg-secondary">Send Wager</Button>
