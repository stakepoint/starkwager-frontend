...
export default function WagerInvite() {
  return (
    <section className="mx-auto py-[2rem] pb-24 lg:py-[4rem] max-w-lg">
      <div>
        {/* Title */}
        <h1 className=" text-blue-950 text-lg lg:text-2xl tracking-tight font-semibold">
          WAGER CREATED
        </h1>
        <p className="text-[#4A5578] tracking-tight">
        ...
        <section className="grid gap-4">
          <div>
            <label className="text-sm text-blue-950 tracking-tighter">
          ...
          <div className="gap-3">
            <p className="text-sm font-medium text-[#102A56] tracking-tighter">
