...
export default function Page() {
  return (
    <div className="flex flex-col justify-between w-full max-w-[400px] lg:max-w-[40%] mx-auto py-16 px-4 lg:px-0 items-start min-h-[90%]">
      ...
      <div className="flex justify-start w-full  lg:pt-8 lg:-mt-6">
        <Button className="w-full max-w-[384px] text-lg font-medium tracking-[-0.36px] dark:bg-secondary">
          Update Changes
        </Button>
      </div>
    </div>
